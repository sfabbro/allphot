...
C     PARAMETER (MAXFRM=67 108 864, PSFMAX=35, NOPT=10)
      PARAMETER (MAXFRM=8 400 000, PSFMAX=35, NOPT=10)
C 
...
C
      ...
      PARAMETER (MAXSTR=400 000, MAXPSF=207, MAXIT=200, MAXMAX=100,
     .     MAXPAR=6, MAXEXP=10)
C
C Parameters:
C
...
C
      INTEGER NCOL, NROW
      CHARACTER COOFIL*40, MAGFIL*40, PSFFIL*40, PROFIL*40, GRPFIL*40, 
     .     SWITCH*40, LINE*80, SUBPIC*40, EXTEND*40, CASE*5,
...
C
 ...
 2195       CONTINUE
            ...
            ERR = AMIN1(AMAX1(ERR, 0.0003), 9.9999)
