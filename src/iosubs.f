...
C
  ...
  901    FORMAT (1X, I2, 2I6, 2F8.1, 5F8.2)
      ELSE
         WRITE (LUN,902) NL, NCOL, NROW, (A(I), I=1,ITEMS)
  902    FORMAT (1x, I2, 2I6, F8.1, F8.0, 5F8.2)
      END IF
...
C
      ...
      END DO
C
C There is at least one non-blank character.  Now truncate at first blank.
C
 5000 DO I=2,K
         IF (LEFT(I:I) .EQ. ' ') THEN
            LEFT = LEFT(1:I)//' '
...
C culture, use this version of the FORMAT statement instead.
C
